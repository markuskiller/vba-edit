...
from vba_edit import __version__ as VBA_EDIT_VERSION
...
def _version_label() -> str:
    return f"v{VBA_EDIT_VERSION}"


def _app_title(app: str | None) -> str:
    base_title = APP_TITLES.get(app or "", "vba-edit - Config Generator")
    return f"{base_title} {_version_label()}"
...
def build_toml(
    *,
    ...
    lines: list[str] = [
        ...
        f"#Generated by vba-edit Config Generator {_version_label()}",
